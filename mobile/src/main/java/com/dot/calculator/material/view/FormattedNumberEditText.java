...
package com.dot.calculator.material.view;
...
import com.dot.calculator.material.util.TextUtil;
...
public class FormattedNumberEditText extends NumberEditText {
    ...
    public void invalidateKeywords(Context context) {
        mKeywords = Arrays.asList(
                context.getString(com.dot.calculator.material.R.string.fun_arcsin) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_arccos) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_arctan) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_sin) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_cos) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_tan) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_arccsc) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_arcsec) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_arccot) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_csc) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_sec) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_cot) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_log) + "(",
                context.getString(com.dot.calculator.material.R.string.mod) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_ln) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_det) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_transpose) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_inverse) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_trace) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_norm) + "(",
                context.getString(com.dot.calculator.material.R.string.fun_polar) + "(",
                context.getString(com.dot.calculator.material.R.string.dx),
                context.getString(com.dot.calculator.material.R.string.dy),
                context.getString(com.dot.calculator.material.R.string.op_cbrt) + "(");
    }
