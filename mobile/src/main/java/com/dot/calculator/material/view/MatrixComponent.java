...
public class MatrixComponent extends CalculatorEditText.SpanComponent {
    ...
    @Override
    public CalculatorEditText.MathSpannable getSpan(String equation) {
    ...
    private static class MatrixSpannable extends CalculatorEditText.MathSpannable {
        ...
        public MatrixSpannable(Context context, String equation) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 21) {
                mBackground = (NinePatchDrawable) mContext.getResources().getDrawable(com.dot.calculator.material.R.drawable.matrix_background, null);
            } else {
                mBackground = (NinePatchDrawable) mContext.getResources().getDrawable(com.dot.calculator.material.R.drawable.matrix_background);
            }
