...
import com.dot.calculator.material.Calculator;
...
public class CalculatorPadView extends RevealFrameLayout {
    ...
    private void setup() {
        ...
        mOffset = getResources().getDimensionPixelSize(com.dot.calculator.material.R.dimen.pad_page_margin);
        mOverlayMargin = getResources().getDimensionPixelSize(com.dot.calculator.material.R.dimen.shadow_margin);
    ...
    protected void onFinishInflate() {
        ...
        mBase = findViewById(com.dot.calculator.material.R.id.base);
        mOverlay = (SolidLayout) findViewById(com.dot.calculator.material.R.id.overlay);
        mTray = findViewById(com.dot.calculator.material.R.id.tray);
        mFab = (FloatingActionButton) findViewById(com.dot.calculator.material.R.id.fab);
